...
namespace Hidistro.UI.Web.Admin.promotion
{
    public class AddGameEgg : AdminPage
    {
        ...
        //    {
        //        CS$<>9__CachedAnonymousMethodDelegate4 = new Func<GamePrizeInfo, bool>(null, (IntPtr) <BindViewInfo>b__0);
        //    }
        //    this.lbPrizeGade0.Text = string.Format("{0}：{1}", PrizeGrade.一等奖, Enumerable.FirstOrDefault<GamePrizeInfo>(prizeLists, CS$<>9__CachedAnonymousMethodDelegate4).PrizeType.ToString());
        //    if (CS$<>9__CachedAnonymousMethodDelegate5 == null)
        //    {
        //        CS$<>9__CachedAnonymousMethodDelegate5 = new Func<GamePrizeInfo, bool>(null, (IntPtr) <BindViewInfo>b__1);
        //    }
        //    this.lbPrizeGade1.Text = string.Format("{0}：{1}", PrizeGrade.二等奖, Enumerable.FirstOrDefault<GamePrizeInfo>(prizeLists, CS$<>9__CachedAnonymousMethodDelegate5).PrizeType.ToString());
        //    if (CS$<>9__CachedAnonymousMethodDelegate6 == null)
        //    {
        //        CS$<>9__CachedAnonymousMethodDelegate6 = new Func<GamePrizeInfo, bool>(null, (IntPtr) <BindViewInfo>b__2);
        //    }
        //    this.lbPrizeGade2.Text = string.Format("{0}：{1}", PrizeGrade.三等奖, Enumerable.FirstOrDefault<GamePrizeInfo>(prizeLists, CS$<>9__CachedAnonymousMethodDelegate6).PrizeType.ToString());
        //    if (CS$<>9__CachedAnonymousMethodDelegate7 == null)
        //    {
        //        CS$<>9__CachedAnonymousMethodDelegate7 = new Func<GamePrizeInfo, bool>(null, (IntPtr) <BindViewInfo>b__3);
        //    }
        //    this.lbPrizeGade3.Text = string.Format("{0}：{1}", PrizeGrade.四等奖, Enumerable.FirstOrDefault<GamePrizeInfo>(prizeLists, CS$<>9__CachedAnonymousMethodDelegate7).PrizeType.ToString());
        //}
