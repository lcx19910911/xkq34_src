namespace Hidistro.UI.Web.Admin.Trade
{
    ...
    public class ManageOrder : AdminPage
    {
        ...
        protected HyperLink hlinkRefund;
                ...
                case "GetOrdersStates":
                    {
                        ...
                        int num7 = OrderHelper.GetCountOrderIDByStatus(Hidistro.Entities.Orders.OrderStatus.BuyerAlreadyPaid, Hidistro.Entities.Orders.OrderStatus.ApplyForRefund) + OrderHelper.GetCountOrderIDByStatus(Hidistro.Entities.Orders.OrderStatus.SellerAlreadySent, Hidistro.Entities.Orders.OrderStatus.ApplyForReturns);//(3, 7);
