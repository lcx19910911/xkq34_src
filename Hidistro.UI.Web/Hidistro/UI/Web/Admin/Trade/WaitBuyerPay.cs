namespace Hidistro.UI.Web.Admin.Trade
{
    ...
    public class WaitBuyerPay : AdminPage
    {
        ...
        protected Button btnConfirmSelPayment;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.btnConfirmSelPayment.Click += new EventHandler(this.btnConfirmSelPayment_Click);
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                Literal literal = (Literal)e.Item.FindControl("litOtherInfo");
                Literal literal2 = (Literal)e.Item.FindControl("WeiXinNickName");
