    ...
    public class SaleService : AdminPage
    {
        ...
        protected void btnBindUser_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(tokenValue))
            {
                ...
                string msg = EnterpriseApi.CreateEnterprise(tokenValue, parameters);
                if (!string.IsNullOrWhiteSpace(msg))
                {
                    string jsonValue = Hishop.MeiQia.Api.Util.Common.GetJsonValue(msg, "errcode");
                    //Hishop.MeiQia.Api.Util.Common.GetJsonValue(msg, "errmsg");
                    if (jsonValue == "10020")
                    {
        ...
        protected void ChangePwd_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(tokenValue))
            {
                ...
                parameters.Add("contact", "");
                parameters.Add("location", "");
                string msg = EnterpriseApi.UpdateEnterprise(tokenValue, parameters);
                if (!string.IsNullOrWhiteSpace(msg))
                {
                    string jsonValue = Hishop.MeiQia.Api.Util.Common.GetJsonValue(msg, "errcode");
                    string str6 = Hishop.MeiQia.Api.Util.Common.GetJsonValue(msg, "errmsg");
                    if (jsonValue == "0")
                    {
