namespace Hidistro.UI.Web.Admin.Bargain
{
    ...
    public class AddBargain : AdminPage
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string s = this.calendarStartDate.Text;
                string str3 = this.calendarEndDate.Text;
                if (string.IsNullOrWhiteSpace(s) || string.IsNullOrWhiteSpace(str3))
                {
                    this.ShowMsg("活动时间不能为空！", false);
                }
                else if (DateTime.Parse(s) >= DateTime.Parse(str3))
                {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (num8 == 0)
                                                    {
                                                        string str6 = this.txtBargainTypeOneValue.Text;
                                                        if (string.IsNullOrWhiteSpace(str6))
                                                        {
                                                            this.ShowMsg("每次砍掉价格不能为空！", false);
                                                            return;
                                                        }
                                                        bargain.BargainTypeMinVlue = float.Parse(str6);
                                                    }
                                                    else
                                                    {
                                                        string str7 = this.txtBargainTypeTwoValue1.Text;
                                                        string str8 = this.txtBargainTypeTwoValue2.Text;
                                                        if (string.IsNullOrWhiteSpace(str7) || string.IsNullOrWhiteSpace(str8))
                                                        {
                                                        ...
                                                        float num9 = 0f;
                                                        float num10 = 0f;
                                                        if (!float.TryParse(str7, out num9))
                                                        {
                                                            this.ShowMsg("随机砍价最小值必须为数值！", false);
                                                            return;
                                                        }
                                                        if (!float.TryParse(str8, out num10))
                                                        {
