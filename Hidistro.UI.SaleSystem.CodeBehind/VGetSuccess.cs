                ...
                case "5":
                    {
                        ...
                        if (result > 0)
                        {
                            ...
                            act = ShareActHelper.GetAct(num2);
                            if (act != null)
                            {
                                coupon = CouponHelper.GetCoupon(act.CouponId);
                            ...
                            else
                            {
                                ...
                                if (act != null)
                                {
                                    ...
                                    if (coupon != null)
                                    {
                                        ...
                                        string str4 = string.Concat(new object[] { Globals.GetWebUrlStart(), "/Vshop/GetRedPager.aspx?id=", num2.ToString(), "&userid=", Globals.GetCurrentMemberUserId(), "&ReferralId=", Globals.GetCurrentDistributorId() });
