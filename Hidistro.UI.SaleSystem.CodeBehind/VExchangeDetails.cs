    ...
    public class VExchangeDetails : VshopTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            if (((info != null) && (product != null)) && (productInfo != null))
            {
                ...
                {
                    str4 = Globals.HostPath(HttpContext.Current.Request.Url) + masterSettings.GoodsPic;
                }
                this.litItemParams.Text = string.Concat(new object[] { str4.Replace("|", "｜"), "|", masterSettings.GoodsName.Replace("|", "｜"), "|", masterSettings.GoodsDescription.Replace("|", "｜"), "$", Globals.HostPath(HttpContext.Current.Request.Url).Replace("|", "｜"), product.ImageUrl1.Replace("|", "｜"), "|", product.ProductName.Replace("|", "｜"), "|", (product.ShortDescription == null) ? "" : product.ShortDescription.Replace("|", "｜"), "|", HttpContext.Current.Request.Url });
            }
            else
            {
