namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VRequestDistributorFinish : VMemberTemplatedWebControl
    {
        ...
        //            {
        //                CS$<>9__CachedAnonymousMethodDelegate1 = new Func<JToken, int>(null, (IntPtr) <AttachChildControls>b__0);
        //            }
        //            DistributorsBrower.AddDistributorProductId(Enumerable.Select<JToken, int>(JObject.Parse(Globals.UrlDecode(cookie.Value)).Values(), CS$<>9__CachedAnonymousMethodDelegate1).ToList<int>());
        //            HttpContext.Current.Response.Cookies["SelectProcutId"].Value = null;
        //        }
        //    }
        //}
