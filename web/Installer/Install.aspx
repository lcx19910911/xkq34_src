...
<body>
        ...
        <div class="main_c">
            ...
            <asp:Label ID="lblErrMessage" runat="server" CssClass="exp"></asp:Label>
                <div class="config_info">
                    ...
                    <div class="c_i_r">
                        <h2>
                            管理员设置<asp:HiddenField ID="hdfSiteName" runat="server" Value="品牌基地" /></h2>
                        <p>
    ...
    <div class="footer">
      <p>Copyright 2015 m.dfqm.cc all Rrghts Reserved.本产品资源均为 福建XXXX科技有限公司 版权所有</p>
    </div>
