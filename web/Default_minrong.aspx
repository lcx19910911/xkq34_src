...
<head>
    ...
    <link rel="stylesheet" href="asset/css/minrong-theme.css" type="text/css">
...
<body style=" ">
    ...
    <div class="membersbox pad50 " id ="divCommon" style="max-width:640px; margin:0 auto;position:relative;">
        ...
        <div class="mr-header">
            ...
            <div class="mr-search">
                <input class="mr-inputTxt" type="text" name="keywords" id="keywords" placeholder="商品搜索：请输入商品关键字">
                <div class="mr-searchIcon" ><img src="asset/images/minrongMain/search.png" class="mr-searchImg"  id="searchBtn"/></div>
            </div>
            <div class="mr-navgation">
                <a href="#">
                    <div class="mr-navClass">
                        <div class="mr-navClass_up mr_navBacksset" style="background-image: url('asset/images/mingrongNav/mrNav1.png');"></div>
                        <div class="mr-navClass_down">
                            公司简介</div>
                    </div>
                </a>
                ...
                <a href="/categories.aspx">
                    <div class="mr-navClass">
                        <div class="mr-navClass_up mr_navBacksset" style="background-image: url('asset/images/mingrongNav/mrNav2.png');"></div>
                        <div class="mr-navClass_down">
                            所有分类</div>
                    </div>
                </a>
                ...
                <a href="/ProductDetails.aspx">
                    <div class="mr-navClass">
                        <div class="mr-navClass_up mr_navBacksset" style="background-image: url('asset/images/mingrongNav/mrNav3.png');"></div>
                        <div class="mr-navClass_down">
                            畅享活动</div>
                    </div>
                </a>
                ...
                <a href="/ProductList.aspx">
                    <div class="mr-navClass">
                        <div class="mr-navClass_up mr_navBacksset" style="background-image: url('asset/images/mingrongNav/mrNav4.png');"></div>
                        <div class="mr-navClass_down">
                            新品上市</div>
                    </div>
                </a>
        ...
        <div class="mr-container">
            <div class="mr-imgSbox">
                <div class="imgChildOne">
                    <img src="asset/images/minrongMain/minrongMain_06.jpg">
                </div>
                <div class="mr-imgChildTwo">
                    <a class="mrCz" href="#"></a>
                    <a class="mrCz" href="#"></a>
                </div>
            </div>
            <div class="mr-imgSbox">
                <a href="#">
                    <div class="imgChildOne">
                        <img src="asset/images/minrongMain/minrongMain_07.jpg">
                    </div>
                </a>
            </div>
            <div class="mr-imgSbox">
                <a href="#">
                    <div class="imgChildOne">
                        <img src="asset/images/minrongMain/minrongMain_08.jpg">
                    </div>
                </a>
            </div>
            <div class="mr-imgSbox">
                <div class="imgChildOne">
                    <img src="asset/images/minrongMain/minrongMain_09.jpg">
                </div>
                <div class="mr-imgChildTwo">
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=11"></a>
                    <a class="mrSz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=#"></a>
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=13"></a>
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=12"></a>
                    <a class="mrSz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=#"></a>
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=3"></a>
                </div>
            </div>
            <div class="mr-imgSbox">
                <div class="imgChildOne">
                    <img src="asset/images/minrongMain/minrongMain_10.jpg">
                </div>
                <div class="mr-imgChildTwo">
                    <a class="mrCz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=5"></a>
                    <a class="mrCz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=7"></a>
                </div>
            </div>
            <div class="mr-imgSbox">
                <div class="imgChildOne">
                    <img src="asset/images/minrongMain/minrongMain_11.jpg">
                </div>
                <div class="mr-imgChildTwo">
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=8"></a>
                    <a class="mrSz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=#"></a>
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=10"></a>
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=9"></a>
                    <a class="mrSz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=#"></a>
                    <a class="mrBz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=1"></a>
                </div>
            </div>
            <div class="mr-imgSbox">
                <div class="imgChildOne">
                    <img src="asset/images/minrongMain/minrongMain_12.jpg">
                </div>
                <div class="mr-imgChildTwo">
                    <a class="mrCz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=4"></a>
                    <a class="mrCz" href="http://wanxiangwuzhou.ppjd.cn/ProductDetails.aspx?productId=6"></a>
                </div>
            </div>
        </div>
            ...
            <ul id="ul">
                <li style="width: 20%;">
                    <div class="navcontent" data="0">
                        <a href="/Default.aspx" class="navcontColor">
                            <img src="asset/images/footer/home-2.png" style="width :20px;height:20px;">
                            主页</a>
                    </div>
                </li>
                <li style="width: 20%;">
                    <div class="navcontent" data="0">
                        <a href="/categories.aspx" class="navcontColor">
                            <img src="asset/images/footer/fl-2.png" style="width :20px;height:20px;">
                            分类</a>
                    </div>
                </li>
                <li style="width: 20%;">
                    <div class="navcontent" data="0">
                        <a href="/Vshop/ShoppingCart.aspx" class="navcontColor">
                            <img src="asset/images/footer/gwc-2.png" style="width :20px;height:20px;">
                            购物车</a>
                    </div>
                </li>
                <li style="width: 20%;">
                    <div class="navcontent" data="0">
                        <a href="/Vshop/MemberCenter.aspx" class="navcontColor">
                            <img src="asset/images/footer/wd-2.png" style="width :20px;height:20px;">
                            我的</a>
                    </div>
                </li>
                <li style="width: 20%;">
                    <div class="navcontent" data="0">
                        <a href="#" class="navcontColor">
                            <img src="asset/images/footer/gl-2.png" style="width :20px;height:20px;">
                            店铺管理</a>
                    </div>
                </li>
        ...
        <section class="members_bottom">
            <section>
                ...
                <a href="/Vshop/DistributorCenter.aspx">分销申请<i></i></a>
                      ...
                      { %>  
            <section style="height:48px;"><a href="http://m.dfqm.cc/" target="_blank" style="color: #b3b3b3;">东方启明·技术支持 </a></section>
        <%} %></section>
    </div>
