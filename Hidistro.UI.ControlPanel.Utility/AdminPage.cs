namespace Hidistro.UI.ControlPanel.Utility
{
    ...
    public class AdminPage : Page
    {
        ...
        private void NotPremissonRedirect(string moduleId, int roleId, [Optional, DefaultParameterValue(null)] string msg)
        {
        ...
        protected virtual void ShowMsgToTarget(string msg, bool success, string targentname)
        {
            ...
            string str3 = targentname.ToLower();
            if ((str3 != null) && ((str3 == "parent") || (str3 == "top")))
            {
                str = targentname + ".";
            }
