namespace Hidistro.UI.SaleSystem.Tags
{
    ...
    public class Common_Footer : SimpleTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            if (this.isShowNav == 1)
            {
                str = str + "<div style='padding-top:60px'></div><script>$(function () { jQuery.getJSON('/api/Hi_Ajax_NavMenu.ashx', function (settingjson) {   $(_.template($('#menu').html())(settingjson)).appendTo('body'); GetUICss();});  }) </script>";
            }
