namespace Hishop.Weixin.Pay.Lib
{
    ...
    {
        public static WxPayData CloseOrder(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
        ...
        public static WxPayData DownloadBill(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
        ...
        public static WxPayData Micropay(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(10)] int timeOut)
        {
        ...
        public static WxPayData OrderQuery(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
        ...
        public static WxPayData Refund(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(60)] int timeOut)
        {
        ...
        public static WxPayData RefundQuery(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
        ...
        public static WxPayData Reverse(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
        ...
        public static WxPayData ShortUrl(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
        ...
        public static WxPayData UnifiedOrder(WxPayData inputObj, PayConfig config, [Optional, DefaultParameterValue(6)] int timeOut)
        {
