namespace Hidistro.Entities.Commodities
{
    ...
    public class BrandCategoryInfo
    {
        ...
        [RegexValidator("^(http)://.*", Ruleset="ValBrandCategory"), ValidatorComposition(CompositionType.Or, Ruleset="ValBrandCategory", MessageTemplate="品牌官方网站的网址必须以http://开头，长度限制在100个字符以内"), NotNullValidator(Negated=true, Ruleset="ValBrandCategory")]
