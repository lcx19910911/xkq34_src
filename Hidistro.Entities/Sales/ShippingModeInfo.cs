namespace Hidistro.Entities.Sales
{
    ...
    public class ShippingModeInfo
    {
        ...
        [RangeValidator(typeof(decimal), "0.00", RangeBoundaryType.Inclusive, "10000000", RangeBoundaryType.Inclusive, Ruleset="ValShippingModeInfo"), ValidatorComposition(CompositionType.Or, Ruleset="ValShippingModeInfo", MessageTemplate="默认加价必须限制在1000万以内"), NotNullValidator(Negated=true, Ruleset="ValShippingModeInfo")]
