namespace Hidistro.Core
{
    ...
    {
        public static string GetDataByKuaidi100(string computer, string expressNo, [Optional, DefaultParameterValue(0)] int show)
        {
            ...
            if (current != null)
            {
                str3 = current.Request.MapPath("~/Express.xml");
            }
        ...
        public static string GetExpressData(string computer, string expressNo, [Optional, DefaultParameterValue(0)] int show)
        {
