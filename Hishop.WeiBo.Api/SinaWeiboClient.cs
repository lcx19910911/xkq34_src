namespace Hishop.WeiBo.Api
{
    ...
    public class SinaWeiboClient : OpenAuthenticationClientBase
    {
        ...
        public SinaWeiboClient(string appKey, string appSecret, string callbackUrl, [Optional, DefaultParameterValue(null)] string accessToken, [Optional, DefaultParameterValue(null)] string uid) : base(appKey, appSecret, callbackUrl, accessToken)
        {
