namespace Hishop.Weixin.MP.Test
{
    ...
    internal class Utils
    {
        ...
        public AbstractRequest ConvertRequest<T>(Stream inputStream) where T: AbstractRequest
        {
            ...
            return new TextRequest { Content = document.SelectSingleNode("xml/Content").InnerText, FromUserName = document.SelectSingleNode("xml/FromUserName").InnerText, MsgId = Convert.ToInt32(document.SelectSingleNode("xml/MsgId").InnerText) };
        }
