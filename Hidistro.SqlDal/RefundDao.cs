namespace Hidistro.SqlDal
{
    ...
    public class RefundDao
    {
        ...
        public bool UpdateOrderGoodStatu(string orderid, string skuid, int OrderItemsStatus)
        {
            ...
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand(str + "update Hishop_OrderItems set OrderItemsStatus=@OrderItemsStatus where orderid=@orderid and skuid=@skuid and type=0");
