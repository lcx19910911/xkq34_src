namespace Hidistro.SqlDal.Weibo
{
    ...
    public class SendAllDao
    {
        ...
        public DbQueryResult GetSendAllRequest(SendAllQuery query, [Optional, DefaultParameterValue(0)] int Platform)
        {
        ...
        public string SaveSendAllInfo(SendAllInfo sendAllInfo, [Optional, DefaultParameterValue(0)] int platform)
        {
        ...
        public bool UpdateAddSendCount(int id, int addcount, [Optional, DefaultParameterValue(-1)] int SendState)
        {
            StringBuilder builder = new StringBuilder();
            if (id > 0)
            {
