namespace Hidistro.SqlDal.Commodities
{
    ...
    public class ProductBrowseDao
    {
        ...
        public DataTable GetProducts(MemberInfo member, int? topicId, int? categoryId, int distributorId, string keyWord, int pageNumber, int maxNum, out int toal, string sort, [Optional, DefaultParameterValue(false)] bool isAsc, [Optional, DefaultParameterValue(false)] bool isselect)
        {
            int discount = 100;
            StringBuilder builder = new StringBuilder();
        ...
        public DataTable GetProducts(MemberInfo member, int? topicId, int? categoryId, int distributorId, string keyWord, int pageNumber, int maxNum, out int toal, string sort, [Optional, DefaultParameterValue(false)] bool isAsc, [Optional, DefaultParameterValue("")] string pIds, [Optional, DefaultParameterValue(false)] bool isLimitedTimeDiscountId)
        {
            int discount = 100;
            StringBuilder builder = new StringBuilder();
        ...
        public int GetProductsNumber(int distributorId, [Optional, DefaultParameterValue(true)] bool isselect)
        {
            int result = 0;
            StringBuilder builder = new StringBuilder();
