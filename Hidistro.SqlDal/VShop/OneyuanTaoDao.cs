namespace Hidistro.SqlDal.VShop
{
    ...
    public class OneyuanTaoDao
    {
        ...
        public bool AddInitParticipantInfo([Optional, DefaultParameterValue(60)] int creatNum)
        {
            ...
            foreach (DateTime time in list)
            {
                ...
                this.database.AddInParameter(sqlStringCommand, "Pid", DbType.String, "B" + time.ToString("yyMMddHHmmssfff"));
                this.database.AddInParameter(sqlStringCommand, "UserId", DbType.Int32, "0");
                this.database.AddInParameter(sqlStringCommand, "BuyTime", DbType.DateTime, time);
        ...
        public bool DelParticipantMember(string ActivityId, [Optional, DefaultParameterValue(true)] bool delAll)
        {
        ...
        public List<string> GetParticipantPids(string ActivityId, [Optional, DefaultParameterValue(true)] bool IsPay, [Optional, DefaultParameterValue(false)] bool IsRefund, [Optional, DefaultParameterValue("alipay")] string PayWay)
        {
        ...
        public string GetSkuStrBySkuId(string Skuid, [Optional, DefaultParameterValue(true)] bool ShowAttribute)
        {
        ...
        public IList<LuckInfo> getWinnerLuckInfoList(string ActivityId, [Optional, DefaultParameterValue("")] string Pid)
        {
            string query = "";
        ...
        public bool SetOneyuanTaoFinishedNum(string ActivityId, [Optional, DefaultParameterValue(0)] int Addnum)
        {
            StringBuilder builder = new StringBuilder();
            if (Addnum > 0)
            {
