namespace Hidistro.SqlDal.VShop
{
    ...
    public class ScanScenceDao
    {
        ...
        public bool getCreatScanId(int userId, [Optional, DefaultParameterValue("WX")] string Platform, [Optional, DefaultParameterValue(0)] int type)
        {
            lock (CreatLockObj)
            {
        ...
        public ScanInfos GetScanInfosByUserId(int Userid, [Optional, DefaultParameterValue(0)] int type, [Optional, DefaultParameterValue("WX")] string Platform)
        {
