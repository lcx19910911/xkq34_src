namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class OneyuanTaoHelp
    {
        ...
        public static bool AddInitParticipantInfo([Optional, DefaultParameterValue(50)] int num)
        {
        ...
        public static bool DelParticipantMember(string ActivityId, [Optional, DefaultParameterValue(true)] bool DelAll)
        {
        ...
        public static OneyuanTaoParticipantInfo GetAddParticipant(int UserId, [Optional, DefaultParameterValue("")] string Pid, [Optional, DefaultParameterValue("")] string payNum)
        {
        ...
        public static string GetOrderNumber([Optional, DefaultParameterValue(true)] bool isActivity)
        {
            lock (Orderidlock)
            {
        ...
        public static IList<OneyuanTaoParticipantInfo> GetParticipantList(string ActivityId, [Optional] int[] UserIds, [Optional] string[] Ids)
        {
            return new OneyuanTaoDao().GetParticipantList(ActivityId, UserIds, Ids);
        }

        public static List<string> GetParticipantPids(string ActivityId, [Optional, DefaultParameterValue(true)] bool IsPay, [Optional, DefaultParameterValue(false)] bool IsRefund, [Optional, DefaultParameterValue("alipay")] string PayWay)
        {
        ...
        public static string GetSkuStrBySkuId(string Skuid, [Optional, DefaultParameterValue(true)] bool ShowAttr)
        {
        ...
        public static IList<LuckInfo> getWinnerLuckInfoList(string ActivityId, [Optional, DefaultParameterValue("")] string Pid)
        {
        ...
        public static bool SetOneyuanTaoFinishedNum(string ActivityId, [Optional, DefaultParameterValue(0)] int Addnum)
        {
