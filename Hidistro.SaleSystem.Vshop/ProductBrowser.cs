namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class ProductBrowser
    {
        ...
        public static DataTable GetProducts(MemberInfo member, int? topicId, int? categoryId, string keyWord, int pageNumber, int maxNum, out int total, string sort, string order, [Optional, DefaultParameterValue("")] string pIds, [Optional, DefaultParameterValue(false)] bool isLimitedTimeDiscountId)
        {
        ...
        public static int GetProductsNumber([Optional, DefaultParameterValue(true)] bool isselect)
        {
