namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class CategoryBrowser
    {
        ...
        public static IList<CategoryInfo> GetMaxMainCategories([Optional, DefaultParameterValue(0x3e8)] int maxNum)
        {
        ...
        public static IList<CategoryInfo> GetMaxSubCategories(int parentCategoryId, [Optional, DefaultParameterValue(0x3e8)] int maxNum)
        {
            IList<CategoryInfo> list = new List<CategoryInfo>();
