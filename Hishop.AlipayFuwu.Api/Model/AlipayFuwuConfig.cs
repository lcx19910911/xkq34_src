namespace Hishop.AlipayFuwu.Api.Model
{
    ...
    public class AlipayFuwuConfig
    {
        ...
        public static bool CommSetConfig(string _appId, string HostPath, [Optional, DefaultParameterValue("GBK")] string _charset)
        {
        ...
        public static void SetConfig(string pubkeyfilepath, string privatefilepath, string alipay_public_keypath, string _appId, [Optional, DefaultParameterValue("GBK")] string _charset)
        {
