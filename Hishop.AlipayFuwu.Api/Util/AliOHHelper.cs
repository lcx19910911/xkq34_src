namespace Hishop.AlipayFuwu.Api.Util
{
    ...
    public class AliOHHelper
    {
        ...
        public static string AlipayAuthUrl(string returnUrl, string app_id, [Optional, DefaultParameterValue("auth_userinfo")] string scope)
        {
        ...
        public static Dictionary<string, string> getRequstParam(HttpContext context)
        {
            ...
            {
                foreach (string str in context.Request.QueryString.AllKeys)
                {
                }
            }
            if (context.Request.Form != null)
            {
                ...
                {
                    dictionary.Add(context.Request.Params.Keys[i].ToString(), context.Request.Params[i].ToString());
                }
            }
            return dictionary;
        }
        ...
        public static void log(string log)
        {
            if (AlipayFuwuConfig.writeLog)
            {
                lock (LockLog)
                {
                    StreamWriter writer = File.AppendText(HttpRuntime.AppDomainAppPath.ToString() + "log/" + (DateTime.Now.ToString("yyyyMMdd") + "_Fuwulog.txt"));
        ...
        public static string SerializeObject(object Articles, [Optional, DefaultParameterValue(true)] bool IgnoreNull)
        {
