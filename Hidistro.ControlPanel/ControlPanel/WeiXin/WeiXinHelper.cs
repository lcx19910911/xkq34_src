namespace ControlPanel.WeiXin
{
    ...
    public class WeiXinHelper
    {
        ...
        public static DbQueryResult GetSendAllRequest(SendAllQuery query, [Optional, DefaultParameterValue(0)] int platform)
        {
        ...
        public static bool UpdateAddSendCount(int id, int addcount, [Optional, DefaultParameterValue(-1)] int SendState)
        {
