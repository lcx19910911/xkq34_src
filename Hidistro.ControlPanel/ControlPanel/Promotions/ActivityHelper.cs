namespace ControlPanel.Promotions
{
    ...
    public class ActivityHelper
    {
        ...
        public static DataTable GetActivityTopics([Optional, DefaultParameterValue("0")] string types)
        {
            return _act.GetActivityTopics(types);
        }

        public static int GetActivityTopicsNum([Optional, DefaultParameterValue("0")] string types)
        {
