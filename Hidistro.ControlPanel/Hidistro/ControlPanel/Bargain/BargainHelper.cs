namespace Hidistro.ControlPanel.Bargain
{
    ...
    public static class BargainHelper
    {
        ...
        public static string GetLinkHtml(string id, string status, [Optional, DefaultParameterValue("0")] string stockNumber, [Optional, DefaultParameterValue("0")] string tranNumber)
        {
