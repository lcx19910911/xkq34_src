namespace Hidistro.ControlPanel.Commodities
{
    ...
    public static class ProductHelper
    {
        ...
        public static IList<ProductInfo> GetProducts(IList<int> productIds, [Optional, DefaultParameterValue(false)] bool Resort)
        {
        ...
        public static bool UpdateProductBaseInfo(DataTable dt)
        {
            ...
            return new ProductBatchDao().UpdateProductBaseInfo(dt);
        }
        ...
        public static bool UpdateShowSaleCounts(DataTable dt)
        {
            ...
            return new ProductBatchDao().UpdateShowSaleCounts(dt);
        }
