namespace Hidistro.ControlPanel.Members
{
    ...
    public static class MemberHelper
    {
        ...
        public static IList<string> BatchCreateMembers(IList<string> distributornames, int referruserId, [Optional, DefaultParameterValue("1")] string createtype)
        {
        ...
        public static IList<MemberGradeInfo> GetMemberGrades([Optional, DefaultParameterValue("")] string GradeIds)
        {
            return new MemberGradeDao().GetMemberGrades(GradeIds);
        }

        public static int GetMemberIdByUserNameOrNiChen([Optional, DefaultParameterValue("")] string username, [Optional, DefaultParameterValue("")] string nich)
        {
            return new MemberDao().GetMemberIdByUserNameOrNiChen(username, nich);
        }

        public static DbQueryResult GetMembers(MemberQuery query, [Optional, DefaultParameterValue(false)] bool isNotBindUserName)
        {
