namespace Hidistro.ControlPanel.Store
{
    ...
    public static class VShopHelper
    {
        ...
        public static DbQueryResult GetDistributors(DistributorsQuery query, [Optional, DefaultParameterValue(null)] string topUserId, [Optional, DefaultParameterValue(null)] string level)
        {
