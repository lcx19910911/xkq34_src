namespace Hidistro.ControlPanel.Store
{
    ...
    public static class HiAffiliation
    {
        ...
        {
            if (Globals.GetCurrentMemberUserId() > 0)
            {
            ...
            if (!HttpContext.Current.Request.QueryString.AllKeys.Contains("returnUrl"))
            {
                ...
                if (!string.IsNullOrEmpty(HttpContext.Current.Request.QueryString["ReferralId"]))
                {
                    ...
                    if (userId > 0)
                    {
                        ...
                        cookie = HttpContext.Current.Request.Cookies["Vshop-ReferralId"];
                        if (cookie == null)
                        {
        ...
        public static void SetReferralIdCookie(string referralId, [Optional, DefaultParameterValue("")] string url, [Optional, DefaultParameterValue(false)] bool isRedirect)
        {
