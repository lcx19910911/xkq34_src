namespace Hidistro.ControlPanel.VShop
{
    ...
    public static class ScanHelp
    {
        ...
        public static bool CreatNewScan(int userId, [Optional, DefaultParameterValue("WX")] string Platform, [Optional, DefaultParameterValue(0)] int type)
        {
        ...
        public static ScanInfos GetScanInfosByUserId(int Userid, [Optional, DefaultParameterValue(0)] int type, [Optional, DefaultParameterValue("WX")] string Platform)
        {
