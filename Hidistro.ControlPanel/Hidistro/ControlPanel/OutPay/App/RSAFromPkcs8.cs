namespace Hidistro.ControlPanel.OutPay.App
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        private static RSAParameters ConvertFromPrivateKey(string pemFileConent)
        {
            ...
            sourceIndex += 0x80;
            sourceIndex += (sourceArray[sourceIndex + 1] == 0x40) ? 2 : 3;
        ...
        public static string sign(string content, string privateKey, string input_charset)
        {
            ...
            return Convert.ToBase64String(provider.SignData(bytes, halg));
        }
        ...
        public static bool verify(string content, string signedString, string publicKey, string input_charset)
        {
            ...
            provider.ImportParameters(parameters);
            SHA1 halg = new SHA1CryptoServiceProvider();
            return provider.VerifyData(bytes, halg, signature);
        }
    }
}
