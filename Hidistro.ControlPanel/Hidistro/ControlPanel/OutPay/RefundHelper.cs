namespace Hidistro.ControlPanel.OutPay
{
    ...
    public static class RefundHelper
    {
        public static string AlipayRefundRequest(string _notify_url, List<alipayReturnInfo> RefundList)
        {
            ...
            string str6 = _notify_url;
            string str7 = masterSettings.Alipay_mid;
            string str8 = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            string str9 = GenerateRefundOrderId();
            string str10 = RefundList.Count.ToString();
            string str11 = "";
            List<string> list = new List<string>();
            foreach (alipayReturnInfo info in RefundList)
            {
                list.Add(info.alipaynum + "^" + info.refundNum.ToString("F2") + "^" + info.Remark);
            }
            str11 = string.Join("#", list);
            ...
            sParaTemp.Add("refund_date", str8);
            sParaTemp.Add("batch_no", str9);
            sParaTemp.Add("batch_num", str10);
            sParaTemp.Add("detail_data", str11);
