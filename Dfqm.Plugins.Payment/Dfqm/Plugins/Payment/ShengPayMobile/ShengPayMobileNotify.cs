namespace Dfqm.Plugins.Payment.ShengPayMobile
{
    ...
    public class ShengPayMobileNotify : PaymentNotify
    {
        ...
        public override void VerifyNotify(int timeout, string configXml)
        {
            ...
            string str22 = this.parameters["SignMsg"];
            XmlDocument document = new XmlDocument();
            document.LoadXml(configXml);
            string str25 = FormsAuthentication.HashPasswordForStoringInConfigFile((str + str2 + str3 + str4 + str5 + str6 + str7 + str8 + str9 + str10 + str11 + str12 + str13 + str14 + str15 + str16 + str17 + str18 + str19 + str20) + document.FirstChild.SelectSingleNode("SellerKey").InnerText, "MD5");
            if ((str12 != "01") || (str21 != str25))
            {
